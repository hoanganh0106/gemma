...
/// The `Ds` norm weight, a real copy in every head slice of both clusters: an HBM load replicates
/// for real over axes absent from the source (`Dummy2` clusters, `HeadCopy4` strided slices) --
