...
## Contract packet2 probe

- Started from the validated P166 packet32 coupled mapping and changed `contract_packet` from `1` to `2`.
- MIR rejected it: `OutPacket 2 is not a valid contraction of Packet Qs % 32`.
