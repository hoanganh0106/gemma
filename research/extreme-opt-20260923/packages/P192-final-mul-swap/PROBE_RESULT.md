...
- P192 swapped the two final output multipliers: `sw` uses `Mul1`, while `inv_rms` uses `Mul0`.
- Binary SHA256: `82F94A398455DA7C2A583CEF2058FD5CB998218E2BD804796B08FAF3B6D5E987`.
- Arena job `96741` passed all 15/15 correctness checks.
- Hardware medians: K1 `80174`, K2 `37971` (`[38317, 37717, 37971]`), K3 `216749`.
- Compared with fresh P166 control `96044` K2 `37697`, P192 is `274` cycles slower; do not promote. Result artifact: `arena-96741.result.txt`.
