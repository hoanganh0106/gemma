...
pub(crate) fn normalize_native_input(
    ...
    // Keep weighted RMSNorm on the native QKV shards. Every input element and
    // every input RMS weight remains live; only the intermediate HBM round trip
    // and remapping pass are removed.
