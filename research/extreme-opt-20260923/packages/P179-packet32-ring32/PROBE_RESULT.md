...
## Arena validation — job 96028

- Source family: C16 ring32/tail120 integrated with P166 packet32 contract.
- Binary SHA256: `5FCCEEB8C60A5AA24F59FC90168BFF8BA9AFFE17E514C2AE540327842E65E5DD`.
- K1 passed, median `80288` cycles (`[83612, 80288, 79887]`).
- K2 timed out on hardware: `rank 0 left request 6 unanswered for 7s`; job failed with exit code 101 before correctness/cycles completed.
- K3 was not reached. Ring32 is rejected for integrated K2; no promotion.
- Result artifact: Arena job `96028`.
