...
pub fn sliding_project_qkv(
    ...
    let (x, x_scale) = sliding::qkv69382::normalize_native_input(device, x, input_rms_weight);
    let q = sliding::qkv69382::project_query(device, &x, &x_scale, q_weight, q_weight_scale);
    ...
    let k = sliding::qkv69382::normalize_weighted(device, &k, k_rms_weight);
    let v = sliding::qkv69382::normalize_value(device, &v);
