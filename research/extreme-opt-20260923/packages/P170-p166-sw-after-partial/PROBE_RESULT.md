...
## sw-after-partial issuer probe

- Moved construction of `sw` after the `partial` commit while preserving all arithmetic and ownership types.
...
- No new Arena submission was made.
