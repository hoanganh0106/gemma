...
axes![Rep8 = 8, Q4 = 4, Rep32 = 32, Ring8 = 8, T2 = 2, Xh = 3840, Rep4 = 4, Ring64 = 64, Xg = 120, Xd = 7680, Ut = 60, Dt = 120, Xp = 64, C2 = 2, Lead4 = 4, Hg = 128, Pw = 32, Sb = 240, Sd = 480];
...
pub(crate) fn feedforward(
    ...
    let partial: DmTensor<f32, Chip, Cluster, m![1 # 32, Hg / 16], m![C2, Hg % 16, Pw = 30]> = partial
        .view()
        .tile::<m![Pw], 30, m![C2, Hg, Pw = 30 # 32]>(0)
        .to_dm(&mut device.tdma);
