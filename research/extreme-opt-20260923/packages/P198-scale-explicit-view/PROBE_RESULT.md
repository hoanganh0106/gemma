...
- Arena job `97131` passed all 15/15 correctness checks.
- Hardware medians: K1 `80351`, K2 `37549` (`[37819, 37097, 37549]`), K3 `216081`.
- P198 is effectively tied with P166 control `96843` K2 `37546` and is 3 cycles slower; do not promote. Result artifact: `arena-97131.result.txt`.
