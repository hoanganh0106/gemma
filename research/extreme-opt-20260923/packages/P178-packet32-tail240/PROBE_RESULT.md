...
## Arena validation — job 95989

- Source family: C15 `Tail = m![1 # 16, H / 240]`, integrated with P166 packet32 contract.
- Binary SHA256: `A4231D7FD11D8ACC61CAFC09205EFC2BBD1674FE8FB8A8C6AF6452DFA431E3DD`.
- K1 passed, median `79518` cycles (`[83716, 79518, 79234]`).
- K2 did not produce a valid result: device timeout, `rank 0 left request 6 unanswered for 7s`; Arena job failed with exit code 101 before K2 correctness/cycles completed.
- K3 was not reached. Tail240 is rejected for integrated K2; no promotion.
- Result artifact: Arena job `95989`.
