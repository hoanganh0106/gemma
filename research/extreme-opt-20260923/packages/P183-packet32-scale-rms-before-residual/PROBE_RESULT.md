...
## Compile probe — z redistribution before residual fetch

- Moved `z.to_dm(...)` before the residual DMA/fetch while retaining P166 packet32 and tail120 mappings.
- Clean SDK 0.8.1 build succeeded.
- Binary SHA256 remained `5965D4748E2428EF04A59223599BC7A67A6BC8AF7728DDC9CCDCA29A4321422F`, identical to P166.
- Compiler canonicalized the order; no duplicate Arena submission was made.
