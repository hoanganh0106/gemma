...
## Compile probe — packet32 parallel lane

- Source change: attempted `LaneMode::Parallel` with the valid packet `m![1 # 8]`.
- SDK 0.8.1 has no `LaneMode::Parallel` variant (`E0599`), so no binary or Arena submission was produced.
