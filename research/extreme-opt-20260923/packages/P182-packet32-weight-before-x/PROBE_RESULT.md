...
## Compile probe — weight DMA before x

- Moved `weight.view().to_dm(...)` before x materialization and quantization while retaining P166 packet32/tail120 mappings.
- Clean SDK 0.8.1 build succeeded.
- Binary SHA256 remained `5965D4748E2428EF04A59223599BC7A67A6BC8AF7728DDC9CCDCA29A4321422F`, identical to P166; compiler canonicalized the scheduling order.
- No duplicate Arena submission was made.
