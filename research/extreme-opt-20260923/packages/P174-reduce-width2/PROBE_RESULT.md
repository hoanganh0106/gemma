...
## Compile probe — reduction width2

- Source change: output contract reduction changed from `vector_narrow_trim 1#4` / reduction `1#4` to `1#2`.
- Clean SDK 0.8.1 build succeeded.
- Resulting binary SHA256: `5965D4748E2428EF04A59223599BC7A67A6BC8AF7728DDC9CCDCA29A4321422F`, identical to P166.
- The compiler canonicalized this change to the existing P166 executable; no new Arena submission was made.
