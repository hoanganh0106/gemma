...
- P186 copied P166 and changed only the final output `vector_narrow_split` from `H / 4 % 30, H % 4` to `H / 8 % 15, H % 8` before the existing `vector_widen_concat`.
- Clean SDK 0.8.1 build succeeded, but the binary SHA256 is identical to P166: `5965D4748E2428EF04A59223599BC7A67A6BC8AF7728DDC9CCDCA29A4321422F`.
- This is compiler canonicalization; no Arena submission was made.
