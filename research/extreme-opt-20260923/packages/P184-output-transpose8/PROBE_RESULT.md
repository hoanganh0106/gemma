...
## Compile probe — final transpose 8-row grouping

- Changed final output transpose from `H%120/4 x H%120%4#16` to `H%120/8 x H%120%8#16`.
- SDK 0.8.1 VISA rejected the transpose: output packet beyond `max_in_rows (4)` must be pure `1#n` padding; requested shape was `H/4%2#4`.
