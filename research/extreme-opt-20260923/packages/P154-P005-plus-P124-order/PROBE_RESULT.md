...
## Arena validation, clean P154 binary (2026-09-25)
...
full public harness: FAIL
pass count: 12/15
medians: K1 79497, K2 37285, K3 217134
```

The clean P154 binary is byte-identical to P126 (`50B7E4929718A47DA24D21161AC223862D9DE6D7666F450C8D263793D35A09EC`).
Arena independently reproduces the same three failing attention-output checks.
P124's source-order change does not produce a distinct hardware candidate and
is rejected with the P126 reshape family.
