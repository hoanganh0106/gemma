...
## Fresh Arena repeat — job 94908

- label: `p159-repeat-20260925`
- binary SHA256: `5965D4748E2428EF04A59223599BC7A67A6BC8AF7728DDC9CCDCA29A4321422F`
- result: `SUCCEEDED`, all 15 checks passed
- K1 median: `80367` cycles
- K2 median: `37629` cycles, samples `[37999, 37629, 37406]`
- K3 median: `217114` cycles
- Result artifact: `arena-94908.result.txt`

The fresh P159 sample is effectively tied with the fresh P158 sample within observed Arena noise; no performance promotion is made from this pair alone.
## P162 compile result

- Combined the P159 contract32 source with the P109 weight-order source change.
- Clean SDK 0.8.1 release build passed.
- Binary SHA256: `390B0501301B94A400DBD5BD0DC0FB96151770D16B137DC0BD56224B970A34C6`.
- This is byte-identical to P159, so the combined source change produced no new codegen. No Arena submission was made for P162.
