...
## Arena validation — job 96187

- Source family: full C13 `H/60 x Qs/512` migration, integrated with P166 packet32 contract.
- Binary SHA256: `60FBB494CCDB29805C962101E0CC9C2C755B2620F2FB523D9B84184B8FBD88D1`.
- All 15 correctness checks passed.
- K1 median `80310`; K2 median `45754` (`[45754, 45693, 46200]`); K3 median `217338`.
- K2 is about 21% slower than P166 control job 96044 (`37697`), so this weight512 family is rejected for promotion despite correctness.
- Result artifact: Arena job `96187`.
