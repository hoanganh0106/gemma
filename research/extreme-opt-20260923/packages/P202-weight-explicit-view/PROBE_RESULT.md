...
- P202 changed the large `weight_dm` allocation to explicit `WeightTile` + `to_dm_view`.
- Clean SDK 0.8.1 build succeeded, but binary SHA256 is identical to P198: `6937028E5D3723C0DEA2EEE9C962E28578CAB0609A76D001414577437D28831A`.
