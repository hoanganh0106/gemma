...
- P191 changed only the `sw = scale * rms_weight` ALU from `Mul0` to `Mul1`.
- Fresh binary SHA256: `7965B7CD67D6AD3A755395E1ED3FD010CA4F7797F6BA867238BFDA97427F0F58`.
- Arena job `96666` passed all 15/15 correctness checks.
- Hardware medians: K1 `79995`, K2 `38578` (`[39171, 37384, 38578]`), K3 `216069`.
- Compared with fresh P166 control job `96044` K2 `37697`, P191 is `881` cycles slower; do not promote. Result artifact: `arena-96666.result.txt`.
