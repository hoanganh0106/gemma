...
axes![Rep8 = 8, Q4 = 4, Rep32 = 32, Ring8 = 8, T2 = 2, Xh = 3840, Rep4 = 4, Ring64 = 64, Xg = 120, Xd = 7680, Ut = 60, Dt = 120, Xp = 64, C2 = 2, Lead4 = 4, Hg = 128, Pw = 64, Sb = 240, Sd = 480, FlatScale = 3686400];
...
fn scales_bf16(
    ...
    let flat: HbmTensorView<f8e4m3, Chip, m![FlatScale]> = unsafe { scale.view().reshape() };
