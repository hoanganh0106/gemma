...
pub(crate) fn feedforward(
    ...
    down_tile!(device, down_weight_packed, x_trf, down_s, partial, 0, 3);
    down_tile!(device, down_weight_packed, x_trf, down_s, partial, 3, 3);
    down_tile!(device, down_weight_packed, x_trf, down_s, partial, 6, 3);
    down_tile!(device, down_weight_packed, x_trf, down_s, partial, 9, 3);
    down_tile!(device, down_weight_packed, x_trf, down_s, partial, 12, 3);
