...
axes![Rep8 = 8, Q4 = 4, Rep32 = 32, Ring8 = 8, T2 = 2, Xh = 3840, Rep4 = 4, Ring64 = 64, Xg = 120, Xd = 7680, Ut = 60, Dt = 120, Xp = 64, C2 = 2, Lead4 = 4, Hg = 128, Pw = 64, Sb = 240, Sd = 480, ClusterCopies = 2];
...
pub(crate) fn feedforward(
    ...
    // Cluster 0 receives local contribution in C2=0 and its peer in C2=1.
