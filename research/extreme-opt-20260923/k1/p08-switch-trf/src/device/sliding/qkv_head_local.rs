...
type NativeSlices = m![Dummy256 / 32, Dummy256 % 32];
pub(crate) type NativeTrf = TrfTensor<f8e4m3, Chip, QkvDualQueryCluster, NativeSlices, m![Dummy2], m![H / 8 % 15, H / 120, H % 8]>;
...
pub(crate) fn normalize_native_input(
    ...
    let trf: TrfTensor<f8e4m3, Chip, QkvDualQueryCluster, Copies, m![Dummy2], m![H / 8 % 15, H / 120, H % 8]> = device.main
        .begin(parts.view())
